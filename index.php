    ...
    <body>
        ...
        <div id="center">
            <form action="index.php" method="get">
                ...
                <?php /* Only search the category, if one was set */ 
                if(isset($_GET["searchCategory"])){ ?> 
                    <input type="hidden" name="searchCategory" value="<?php echo $_GET["searchCategory"];?>">
                <?php } ?>
            </form>
